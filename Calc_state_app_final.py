...
class main_window(QWidget, Ui_Form):
    ...
    def Calculate(self):
        ...
        self.le_P.setText(str(round(self.Steam.P, 5)))
        self.le_T.setText(str(round(self.Steam.T, 5)))
        self.le_Q.setText(str(round(self.Steam.x, 5)))
        self.le_H.setText(str(round(self.Steam.h, 5)))
        self.le_S.setText(str(round(self.Steam.s, 5)))
        self.le_SpV.setText(str(round(self.Steam.v, 5)))
